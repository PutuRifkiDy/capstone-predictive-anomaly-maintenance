...
export default function MaintenanceTicketUpdate({ authedUser, onLogout }) {
  ...
  }, [setTitle, setDescription, setStatus, params.id]);
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      const result = await updateMaintenanceTicketById(params.id, {
        title,
        description,
        status,
      });
