...
export default function Dashboard({ authedUser, onLogout }) {
  return (
    <AppLayout authedUser={authedUser} onLogout={onLogout}>
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-5 pt-[45px]">
        <div className="flex items-center justify-center flex-row bg-white dark:bg-[#081028] border-gray-200 border-[1px] rounded-[15px] px-[20px] py-[20px]  gap-[20px] shadow-sm">
          <div>
            <p className="text-gray-400">Total Machine</p>
            <p className="font-medium text-[34px]">10.000</p>
          </div>
          <div className="bg-[#515DEF]/30 rounded-[10px] h-[69px] w-[69px] flex justify-center items-center">
            <MachineIcon />
          </div>
        </div>
        <div className="flex flex-row justify-center items-center bg-white dark:bg-[#081028] border-gray-200 border-[1px] rounded-[15px] px-[20px] py-[20px] gap-[20px] shadow-sm">
          <div>
            <p className="text-gray-400">Normal Machine</p>
            <p className="font-medium text-[34px]">9.300</p>
          </div>
        ...
        <div className="flex flex-row justify-center items-center bg-white dark:bg-[#081028] border-gray-200 border-[1px] rounded-[15px] px-[20px] py-[20px] gap-[20px] shadow-sm">
          <div>
            ...
            <p className="font-medium text-[34px]">700</p>
          </div>
        ...
        <div className="flex flex-row justify-center items-center bg-white dark:bg-[#081028] border-gray-200 border-[1px] rounded-[15px] px-[20px] py-[20px] gap-[20px] shadow-sm">
          <div>
            ...
            <p className="font-medium text-[34px]">87%</p>
          </div>
      ...
      <div className="flex flex-col md:flex-row mt-[40px] gap-10">
        <div className="bg-white dark:bg-[#081028] border-gray-200 border-[1px] rounded-[15px] px-[24px] py-[29px] shadow-sm w-full md:w-1/3 h-[429px]">
          <p className="font-medium text-[20px]">Fail Type Distribution</p>
          <p>Pie Chart</p>
        </div>
        <div className="bg-white dark:bg-[#081028] border-gray-200 border-[1px] rounded-[15px] px-[24px] py-[29px] w-full md:w-2/3 shadow-sm">
