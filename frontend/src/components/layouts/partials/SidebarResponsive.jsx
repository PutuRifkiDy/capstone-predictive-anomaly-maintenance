...
export default function SidebarResponsive({ isSidebarOpenMobile, authedUser, onLogout }) {
  const location = useLocation();
  const currentPath = location.pathname;

  return (
    <nav className="flex flex-1 flex-col bg-white dark:bg-[#081028]">
      <header className="flex justify-center items-center gap-3 shrink-0 h-24">
        <CompanyLogo />
            ...
            <li>
              <ul role="list" className="space-y-2">
                <li>
                  ...
                  group flex gap-x-3 ${
                    isSidebarOpenMobile == true ? "rounded-md" : ""
